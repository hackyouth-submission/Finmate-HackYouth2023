...
function DetailsProduct() {
  ...
  var project = {
    ...
    customer: (
      <div>
        ...
        <div className="proj-info">
          <div className="content">
            When you use a Node.js module in the browser, Vite will output the
            following warning. Module "fs" has been externalized for browser
            compatibility. Cannot access "fs.readFile" in client code. This is
            because Vite does not automatically polyfill Node.js modules. We
            recommend avoiding Node.js modules for browser code to reduce the
            bundle size, although you can add polyfills manually. If the module
            is imported from a third-party library (that's meant to be used in
            the browser), it's advised to report the issue to the respective
            library.
          </div>
        </div>
      </div>
  ...
  if (project.verified) {
    verifiedList.push(
      <Tab eventKey={"customer"} title="Customer surver">
        {project.customer}
      </Tab>,
      <Tab eventKey={"test"} title="Product test">
        {project.beta}
      </Tab>,
      <Tab eventKey={"beta"} title="Beta products">
        {project.test}
      </Tab>,
  ...
  return (
    <div id="detail-product-container">
      <Header />
      <div className="row">
        <div className="col-5">
